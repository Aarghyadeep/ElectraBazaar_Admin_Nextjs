...
export default function Header() {
  ...
  return (
    <div className="top-0 bg-[#1E1E1E] w-full p-2 flex text-white justify-between border-b border-gray-600">
                {/* logo */}
      ...
      hover:opacity-90'>
           ...
           ElectraBazaar
           <p className="text-red-500 ml-1 mb-2 text-sm">Admin</p>
           </Link>
       ...
       { session?.user?.image ? (
         ...
         <p className="bg-gray-600 w-10 h-10 rounded-full mr-5">{session?.user?.name}</p>
       )
       }
       </button>
